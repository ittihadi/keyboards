...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GALLIUM] = LAYOUT_split_3x6_3(
     ...
     /* 
      * ┌───────┬───────┬───────┬───────┬───────┬───────┐       ┌───────┬───────┬───────┬───────┬───────┬───────┐
      * │       │       │  Tab  │ CSTab │ C-Tab │       │       │ Pscrn │ Ctl Y │       │ C-Bsp │  Del  │       │
      * ├───────┼───────┼───────┼───────┼───────┼───────┤       ├───────┼───────┼───────┼───────┼───────┼───────┤
      * │       │  GUI  │ OSAlt │ OSSft │ OSCtl │ CWSpc │       │   ←   │   ↓   │   ↑   │   → 	│  Bsp  │       │
      * ├───────┼───────┼───────┼───────┼───────┼───────┤       ├───────┼───────┼───────┼───────┼───────┼───────┤
    ...
    [_NAV] = LAYOUT_split_3x6_3(
        XXXXXXX, XXXXXXX,  KC_TAB, CSH_TAB, CTL_TAB, XXXXXXX,                             KC_PSCR, C(KC_Y), XXXXXXX, DEL_WORD, KC_DEL, XXXXXXX,
        XXXXXXX, KC_LGUI, OS_ALT,  OS_SHFT, OS_CTRL, CW_NCSP,                             KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,KC_BSPC, XXXXXXX,
        XXXXXXX, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), XXXXXXX,                             KC_HOME, KC_PGDN, KC_PGUP, KC_END,   KC_ESC, XXXXXXX,
                                            XXXXXXX, _______, LA_MOUS,           KC_ENT,  _______, XXXXXXX
    ),
     /*
      * ┌───────┬───────┬───────┬───────┬───────┬───────┐       ┌───────┬───────┬───────┬───────┬───────┬───────┐
      * │       │   `   │   <   │   >   │   -   │   |   │       │   ^   │   {   │   }   │   $   │   \   │  Del  │
